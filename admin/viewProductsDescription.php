...
$parentcatid = $_GET['parentid'];
$childcatid = $_GET['childid'];
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">View Products Description</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                    ...
                    <div class="row" id='page_content'>
						...
						//$type = $_GET['type'];
                         $productArr=$kProduct->loadProducts($productId);
                          include( __APP_PATH_VIEW_FILES__ . "/viewProductsDescription.php" );
                        ?>
                    </div>
                </div>
            </div>
