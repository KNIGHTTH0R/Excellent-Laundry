...
set_time_logout();
checkAuthAdmin();
$pagetitle=__SITE_TITLE__.'Order Report PDF';
...
$pdf->SetSubject('Order Report PDF');
...
if(!empty($orderArr)){
    $pdf->AddPage();
            ...
            <div><p style="text-align:center; font-size:18px; color:#000"><b>Order Report </b></p></div>
