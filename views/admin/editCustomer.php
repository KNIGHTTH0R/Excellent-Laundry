...
if(empty($_POST['editUserAry'])){
        $addressAry = explode('$', $customerData[0]['address']);
        $_POST['editUserAry']['usUniqueCode'] =$customerData[0]['uniquecode'];
        $_POST['editUserAry']['usBusinessName'] =$customerData[0]['business_name'];
        $_POST['editUserAry']['usContactName']=$customerData[0]['contact_name'];
        $_POST['editUserAry']['usphone'] =$customerData[0]['phoneno'];
        $_POST['editUserAry']['usmobile']=$customerData[0]['mobileno'];
        $_POST['editUserAry']['usEmail'] =$customerData[0]['contact_email'];
        $_POST['editUserAry']['usBusinessEmail']=$customerData[0]['business_email'];
        $_POST['editUserAry']['usStAddress1'] =$addressAry[0];
        $_POST['editUserAry']['usStAddress2']=$addressAry[1];
        $_POST['editUserAry']['usState'] =$customerData[0]['state']; 
        $_POST['editUserAry']['usPostcode']=$customerData[0]['postcode'];
        $_POST['editUserAry']['usStartDate'] =date('d/m/Y',strtotime($customerData[0]['contract_start']));
        $_POST['editUserAry']['usEndDate']=date('d/m/Y',strtotime($customerData[0]['contract_end']));
        $_POST['editUserAry']['usgroup']=$customerData[0]['groupid'];
        $_POST['editUserAry']['id']=$customerData[0]['id'];
        $_POST['editUserAry']['userid']=$customerData[0]['userid'];
    $_POST['editUserAry']['soc']=$customerData[0]['soc'];
    }
?>
<div class="col-md-12">
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-grey-sunglo bold uppercase">Edit Customer</span>
            </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form name="editUserForm" id="editUserForm" method="post" class="form-horizontal" >
                <div class="form-body">
                     <div class="form-group <?php if($kUser->arErrorMessages['usUniqueCode'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control" name="editUserAry[usUniqueCode]" id='usUniqueCode' onfocus="remove_formError(this.id,'true')" placeholder="Unique Code" value='<?php echo $_POST['editUserAry']['usUniqueCode']; ?>'> 
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usBusinessName'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control" name="editUserAry[usBusinessName]" id='usBusinessName' onfocus="remove_formError(this.id,'true')" placeholder="Business Name" value='<?php echo $_POST['editUserAry']['usBusinessName']; ?>'> 
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usContactName'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control" name="editUserAry[usContactName]" id='usContactName' onfocus="remove_formError(this.id,'true')" placeholder="Contact Name" value='<?php echo $_POST['editUserAry']['usContactName']; ?>'> 
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usphone'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control" name="editUserAry[usphone]" id='usphone' onfocus="remove_formError(this.id,'true')" placeholder="Phone Number" value='<?php echo $_POST['editUserAry']['usphone']; ?>'> 
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usmobile'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control" name="editUserAry[usmobile]" id='usmobile' onfocus="remove_formError(this.id,'true')" placeholder="Mobile Number" value='<?php echo $_POST['editUserAry']['usmobile']; ?>'> 
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usEmail'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="editUserAry[usEmail]" id='usEmail' onfocus="remove_formError(this.id,'true')" placeholder="Contact Email Address" value='<?php echo $_POST['editUserAry']['usEmail']; ?>'>
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usBusinessEmail'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="editUserAry[usBusinessEmail]" id='usBusinessEmail' onfocus="remove_formError(this.id,'true')" placeholder="Business Email Address" value='<?php echo $_POST['editUserAry']['usBusinessEmail']; ?>'>
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usStAddress1'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="editUserAry[usStAddress1]" id='usStAddress1' onfocus="remove_formError(this.id,'true')" placeholder="Street Address 1" value='<?php echo $_POST['editUserAry']['usStAddress1']; ?>'>
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usStAddress2'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="editUserAry[usStAddress2]" id='usStAddress1' onfocus="remove_formError(this.id,'true')" placeholder="Street Address 2" value='<?php echo $_POST['editUserAry']['usStAddress2']; ?>'>
                            </div>
                    ...
                    <div id="mycountry" class="form-group <?php if($kUser->arErrorMessages['usCountry'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <select class="form-control custom-select" name="editUserAry[usCountry]" id="countries" onfocus="remove_formError(this.id,'true')">
                    ...
                    <div id="mystate" class="form-group <?php if($kUser->arErrorMessages['usState'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <select class="form-control custom-select" name="editUserAry[usState]" id="states" onfocus="remove_formError(this.id,'true')">
                                        <option value="">States</option>
                                        <?php 
                                        $statesarr = $kCommon->loadState(0);
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usPostcode'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input autocomplete="off" type="text" class="form-control" name="editUserAry[usPostcode]" id='usPostcode' onfocus="remove_formError(this.id,'true')" placeholder="Post Code" value='<?php echo $_POST['editUserAry']['usPostcode']; ?>'> 
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['soc'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input autocomplete="off" type="checkbox" <?php echo ($_POST['editUserAry']['soc']=='1'?'checked="checked"':''); ?> class="form-control" name="editUserAry[soc]" id='ussoc' onfocus="remove_formError(this.id,'true')" value='1'>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="input-group input-large date-picker input-daterange" data-date="<?php echo date('d/m/Y')?>" data-date-format="dd/mm/yyyy">
                               <span class="input-group-addon">
                                ...
                                <input type="text" class="form-control date" name="editUserAry[usStartDate]" id="strtdt" placeholder="Start Date" value="<?php echo $_POST['editUserAry']['usStartDate']?>">
                            </div>
                    ...
                    <div class="form-group <?php if($kUser->arErrorMessages['usEndDate'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group input-large date-picker input-daterange" data-date="<?php echo date('d/m/Y')?>" data-date-format="dd/mm/yyyy">
                                ...
                                <input type="text" class="form-control date1" name="editUserAry[usEndDate]" id="enddt" placeholder="End Date" value="<?php echo $_POST['editUserAry']['usEndDate']?>">
                            </div>
...
<!--                    <div id="mygroup" class="form-group <?php if($kUser->arErrorMessages['usgroup'] !=''){ ?> has-error <?php } ?>">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <select class="form-control custom-select" name="editUserAry[usgroup]" id="groups" onfocus="remove_formError(this.id,'true')">
                                        ...
                                        //{
                                                ...
                                                //{
                                                        //$selected = ($group['id'] == $_POST['editUserAry']['usgroup'] ? 'selected="selected"' : '');	
                    ...
                    <input autocomplete="off" type="hidden" class="form-control" name="editUserAry[id]" id='id' onfocus="remove_formError(this.id,'true')"  value='<?php echo $_POST['editUserAry']['id']; ?>'> 
                     <input autocomplete="off" type="hidden" class="form-control" name="editUserAry[userid]" id='userid' onfocus="remove_formError(this.id,'true')"  value='<?php echo $_POST['editUserAry']['userid']; ?>'> 
                    
                </div>
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-4">
                            <button class="btn blue" onclick="editUser(); return false;">Save</button>
